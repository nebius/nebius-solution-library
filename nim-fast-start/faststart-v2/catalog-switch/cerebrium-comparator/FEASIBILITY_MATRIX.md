...
| Internal Qwen3 matched new target | same Qwen revision/runtime/request | fresh broker-issued eu-north1 1xH100 | PLANNABLE | Offline broker contract available. Do not provision before matched configuration and live campaign approval are frozen. |
