...
| Internal Qwen3 matched new target | same Qwen revision/runtime/request | fresh broker-issued eu-north1 1xH100 | PRE-CREATION REVIEW v6 | Fresh direct child of rejected v5 `548a7bf1`: public-only Ed25519 verifier, host output-drop before any listener, controller zero-egress restart, and sealed four-group CLI. Lease is PLANNED with zero resources; exact-commit clearance is absent. |
