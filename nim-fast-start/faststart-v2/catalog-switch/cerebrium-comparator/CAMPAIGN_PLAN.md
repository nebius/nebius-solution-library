...
The only admitted groups are `qwen-smoke-01`, `qwen-scout-01`,
`qwen-scout-02`, and `qwen-scout-03`; exactly four must complete. Every group
contains two requests. Ordinal 1
