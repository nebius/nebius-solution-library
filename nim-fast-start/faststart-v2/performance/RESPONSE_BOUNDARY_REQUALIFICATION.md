...
OpenFold2, Boltz2, GenMol, and MSA Search completed coherent response-boundary
...
Their medians are 14.236758, 27.342018, 12.177434, and 4.942788 seconds
...
Three stable production-shaped lanes still require an exact-total rerun.
...
All three reruns must retain the existing warm-instance boundaries: Ready GPU
...
GenMol and MSA Search completed this response-boundary requalification;
MolMIM and RFdiffusion were qualified directly under the same contract. None
is part of the remaining rerun list. RFdiffusion's selected
