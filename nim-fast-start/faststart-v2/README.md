...
OpenFold2, Boltz2, ProteinMPNN, MSA Search, GenMol, RFdiffusion, and MolMIM
retain exact T0-to-second-response boundaries; two older stable lanes retain exact
