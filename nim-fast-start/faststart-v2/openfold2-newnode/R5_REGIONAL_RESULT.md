...
all run-scoped resources, recreated the holder Ready on t12, and confirmed both
RWO volumes attached there.

Raw evidence:

`/home/tux/.local/state/archvteams-2407/openfold2-newnode-production-20260818/runs/of2-newnode-r5-regional/`
