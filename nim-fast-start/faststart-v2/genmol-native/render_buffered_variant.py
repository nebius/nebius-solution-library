#!/usr/bin/env python3
"""Render a write-once direct-to-buffered GenMol artifact variant Job."""
...
def read_receipt(path: Path) -> dict[str, Any]:
    ...
    if (
        value["schema"] != "archvteams.nebius.ai/genmol-native-artifact-receipt/v1"
...
print(json.dumps({{
    "schema": "archvteams.nebius.ai/genmol-buffered-build/v1",
    "status": "PASS",
