...
def run_config() -> dict:
    return {
        ...
        "checkpoint_id": "msa-search-native-f7-v1",
        "artifact_version": "1",
        "artifact_manifest_sha256": "5" * 64,
        "artifact_pvc": "msa-search-native-artifacts",
        "cache_pvc": "msa-search-nim-cache",
    }
...
def target_binding() -> dict:
    return {
        ...
        "pod_name": "msa-target-ut-a1b2c3",
        "pod_uid": "11111111-1111-4111-8111-111111111111",
        "container_name": "msa-search",
...
class RenderTests(unittest.TestCase):
    ...
    def test_binding_requires_exact_image_digest(self) -> None:
        bad = target_binding()
        bad["image_id"] = "nvcr.io/nim/colabfold/msa-search@sha256:" + "0" * 64
        with self.assertRaisesRegex(render.RenderError, "exact pinned MSA Search"):
            render.validate_binding(bad, self.run)
    ...
    def test_buffered_candidate_is_explicit_and_accepts_measured_glibc(self) -> None:
        ...
        candidate["checkpoint_id"] = "msa-search-native-f7-v2-buffered"
        self.assertEqual(
...
class UnsafeMutationTests(unittest.TestCase):
    ...
    def test_rejects_mutable_image_tag(self) -> None:
        ...
        pod["spec"]["containers"][0]["image"] = "nvcr.io/nim/colabfold/msa-search:1.0"
    ...
    def test_rejects_probe_third_request(self) -> None:
        ...
        self.assert_rejected(documents, "exactly two fixed strict MSA Search probes")
    ...
    def test_rejects_probe_using_projected_fixture_directly(self) -> None:
        ...
        spec["volumes"][0] = {
            "name": "validator",
            "configMap": {"name": "msa-semantic-ut-a1b2c3", "defaultMode": 0o444},
        }
