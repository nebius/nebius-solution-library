#!/usr/bin/env python3
"""Render a write-once direct-to-buffered MSA Search artifact variant Job."""
...
SOURCE_ID = "msa-search-native-f7-v1"
DESTINATION_ID = "msa-search-native-f7-v2-buffered"
NODE = "gpu-node-a.example.invalid"
PVC = "msa-search-native-f7-artifacts"
PYTHON_IMAGE = (
...
def read_receipt(path: Path) -> dict[str, Any]:
    ...
    if (
        value["schema"] != "archvteams.nebius.ai/msa-search-native-artifact-receipt/v1"
...
print(json.dumps({{
    "schema": "archvteams.nebius.ai/msa-search-buffered-build/v1",
    "status": "PASS",
...
def render(receipt: dict[str, Any]) -> list[dict[str, Any]]:
    ...
    job = {
        ...
        "kind": "Job",
        "metadata": {
            "name": "msa-search-native-f7-v2-buffered-build",
