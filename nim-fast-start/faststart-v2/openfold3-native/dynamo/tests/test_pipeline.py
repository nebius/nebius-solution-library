...
CROSS_LANGUAGE_SPEC_SHA256 = (
    "0f674c15e081fbe4544b74f0bf884601cabfe70d71b4c2fb5f1f85cd0cb1b033"
)
...
def evidence_inputs() -> dict:
    ...
    worker_receipt = {
        ...
        "target_name": f"of3-target-{run_id}",
        "target_uid": POD_UID,
    ...
    semantic = {
        ...
        "endpoint": f"http://{service_name}:8000/biology/openfold/openfold3/predict",
        "inference_path": "/biology/openfold/openfold3/predict",
...
class BindingTests(unittest.TestCase):
    def test_python_matches_go_worker_canonical_pod_spec_fixture(self) -> None:
        fixture_path = TEST_DIR / "fixtures" / "openfold3-api-pod-spec.json"
