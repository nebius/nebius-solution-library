...
def run_config() -> dict:
    return {
        ...
        "checkpoint_id": "openfold3-native-f7-v1",
        "artifact_version": "1",
        "artifact_manifest_sha256": "5" * 64,
        "artifact_pvc": "openfold3-native-artifacts",
        "cache_pvc": "openfold3-nim-cache",
    }
...
class RenderTests(unittest.TestCase):
    ...
    def test_binding_requires_exact_image_digest(self) -> None:
        bad = target_binding()
        bad["image_id"] = "nvcr.io/nim/openfold/openfold3@sha256:" + "0" * 64
        with self.assertRaisesRegex(render.RenderError, "exact pinned OpenFold3"):
            render.validate_binding(bad, self.run)
    ...
    def test_buffered_candidate_is_explicit_and_accepts_measured_glibc(self) -> None:
        ...
        candidate["checkpoint_id"] = "openfold3-native-f7-v2-buffered"
        self.assertEqual(
...
class UnsafeMutationTests(unittest.TestCase):
    ...
    def test_rejects_mutable_image_tag(self) -> None:
        ...
        pod["spec"]["containers"][0]["image"] = "nvcr.io/nim/openfold/openfold3:1.0"
    ...
    def test_rejects_probe_third_request(self) -> None:
        ...
        self.assert_rejected(documents, "exactly two fixed strict OpenFold3 probes")
    ...
    def test_rejects_probe_using_projected_fixture_directly(self) -> None:
        ...
        spec["volumes"][0] = {
            "name": "validator",
            "configMap": {"name": "of3-semantic-ut-a1b2c3", "defaultMode": 0o444},
        }
