...
readonly expected_contract_sha256="4136458c641e2b3faf07b638fcdf359be158937f82de9c929b4c4076e5209c5c"
readonly expected_validator_sha256="245ae98a98db09c34924cd7a499b99da9eb35742667043aaee3e497c33268008"
...
readonly validator_path="${script_dir}/../validate_diffdock.py"
readonly fixture_path="${script_dir}/../fixtures/1ubq-aspirin-request.json"
...
if [[ $trial_holder != "diffdock-native-f7-holder-hf93" ]]; then
...
readonly trial_target="dd-target-${trial_run_id}"
readonly trial_worker="dd-restore-${trial_run_id}"
readonly trial_probe="dd-semantic-${trial_run_id}"
readonly trial_canary="dd-canary-${trial_run_id}"
...
if ! jq -e --arg node "$trial_node" '
  ...
  any(.spec.volumes[]?;
    .name == "artifacts" and
    .persistentVolumeClaim.claimName == "diffdock-native-f7-artifacts" and
    .persistentVolumeClaim.readOnly == true) and
  any(.spec.volumes[]?;
    .name == "nim-cache" and
    .persistentVolumeClaim.claimName == "diffdock-native-f7-cache" and
...
jq -n \
  ...
  '{
    schema:"archvteams.nebius.ai/diffdock-faststart-run/v1",
    demand_at:$demand_at,
    run_id:$run_id,
    target_node:$node,
    ...
    artifact_pvc:"diffdock-native-f7-artifacts",
    cache_pvc:"diffdock-native-f7-cache"
  }' > "$trial_dir/run.json"
