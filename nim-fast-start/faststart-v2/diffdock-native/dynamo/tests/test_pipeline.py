...
CROSS_LANGUAGE_SPEC_SHA256 = (
    "2634a95e0f7a9019299fb51fc5a8b087f8c573822aac1f2dd93d0d3faa23b560"
)
...
def evidence_inputs() -> dict:
    ...
    worker_receipt = {
        ...
        "target_name": f"dd-target-{run_id}",
        "target_uid": POD_UID,
    ...
    semantic = {
        ...
        "endpoint": f"http://{service_name}:8000/molecular-docking/diffdock/generate",
        "inference_path": "/molecular-docking/diffdock/generate",
...
class BindingTests(unittest.TestCase):
    def test_python_matches_go_worker_canonical_pod_spec_fixture(self) -> None:
        fixture_path = TEST_DIR / "fixtures" / "diffdock-api-pod-spec.json"
...
class EvidenceTests(unittest.TestCase):
    ...
    def test_two_semantic_responses_produce_demand_timing(self) -> None:
        ...
        self.assertEqual(
            receipt["evidence"]["worker_executable_sha256"],
            approved_contract()["worker_executable_sha256"],
        )
        self.assertEqual(
