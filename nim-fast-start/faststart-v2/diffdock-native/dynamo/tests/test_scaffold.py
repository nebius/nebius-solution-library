...
def run_config() -> dict:
    return {
        ...
        "checkpoint_id": "diffdock-native-f7-v1",
        "artifact_version": "1",
        "artifact_manifest_sha256": "5" * 64,
        "artifact_pvc": "diffdock-native-artifacts",
        "cache_pvc": "diffdock-nim-cache",
    }
...
class RenderTests(unittest.TestCase):
    ...
    def test_binding_requires_exact_image_digest(self) -> None:
        bad = target_binding()
        bad["image_id"] = "nvcr.io/nim/mit/diffdock@sha256:" + "0" * 64
        with self.assertRaisesRegex(render.RenderError, "exact pinned DiffDock"):
            render.validate_binding(bad, self.run)
    ...
    def test_rootfsless_candidate_accepts_measured_older_target_glibc(self) -> None:
        candidate = run_config()
        candidate["target_glibc_version"] = "2.35"
        candidate["checkpoint_id"] = "diffdock-native-f7-v2-rootfsless"
        self.assertEqual(
            render.validate_run(candidate)["target_glibc_version"],
            "2.35",
        )
    ...
    def test_contract_requires_worker_executable_digest(self) -> None:
        ...
        with self.assertRaisesRegex(render.RenderError, "worker_executable_sha256"):
...
class UnsafeMutationTests(unittest.TestCase):
    ...
    def test_rejects_mutable_image_tag(self) -> None:
        ...
        pod["spec"]["containers"][0]["image"] = "nvcr.io/nim/mit/diffdock:1.0"
    ...
    def test_rejects_probe_third_request(self) -> None:
        ...
        self.assert_rejected(documents, "exactly two fixed strict DiffDock probes")
    ...
    def test_probe_stages_fixture_as_regular_file_on_hf93(self) -> None:
        ...
        self.assertEqual(values, ["gpu-node-a.example.invalid"])
    ...
    def test_rejects_probe_using_projected_fixture_directly(self) -> None:
        ...
        spec["volumes"][0] = {
            "name": "validator",
            "configMap": {"name": "dd-semantic-ut-a1b2c3", "defaultMode": 0o444},
        }
