#!/usr/bin/env python3
"""Create a hard-linked buffered RFdiffusion artifact variant without overwriting data."""
...
def build_variant(
    ...
    return {
        "schema": "archvteams.nebius.ai/rfdiffusion-buffered-artifact-build/v1",
        "status": "PASS",
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    try:
        ...
        print(f"rfdiffusion-artifact-variant: refused: {exc}", file=sys.stderr)
        return 2
