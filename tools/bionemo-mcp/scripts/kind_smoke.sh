...
IMAGE=${BIONEMO_MCP_IMAGE:-nebius-bionemo-mcp:archvteams-2370-local}
...
kubectl --context "$CONTEXT" --namespace bionemo rollout status deployment/boltz2 --timeout 120s
