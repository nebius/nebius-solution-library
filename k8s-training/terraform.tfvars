...
parent_id      = "project-e00bfvnxfz295vvpysn77" # The project-id in this context
subnet_id      = "vpcsubnet-e00nw2ybx7mk0gpkej" # Use the command "nebius vpc v1alpha1 network list" to see the subnet id
