    ...
    template {
      ...
      spec {
        ...
        container {
          ...
          resources {
            limits = {
              cpu              = local.nim_resources.cosmos_reason2_8b.cpu_limit
              memory           = local.nim_resources.cosmos_reason2_8b.memory_limit
              "nvidia.com/gpu" = local.nim_resources.cosmos_reason2_8b.gpu
            }
            requests = {
              cpu              = local.nim_resources.cosmos_reason2_8b.cpu_request
              memory           = local.nim_resources.cosmos_reason2_8b.memory_request
              "nvidia.com/gpu" = local.nim_resources.cosmos_reason2_8b.gpu
            }
          }
        ...
        volume {
          ...
          empty_dir {
            medium     = "Memory"
            size_limit = local.nim_resources.cosmos_reason2_8b.shm
          }
        }
        volume {
          name = "mnt-data"
